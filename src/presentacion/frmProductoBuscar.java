...
public class frmProductoBuscar extends javax.swing.JDialog {
    ...
    private void filtrar() {
        try {
            int anchoColumnas[] = {100, 300,100};
            String alinearColumnas[] = {"C", "I", "I"};
            Funciones.llenarTablaBusqueda(tblListado, resultado, anchoColumnas, alinearColumnas, "nombre", txtValorBusqueda.getText());
